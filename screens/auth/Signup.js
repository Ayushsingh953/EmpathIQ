        ...
        <StatusBar style="dark" />
         ...
         <View style={{justifyContent:"center",alignItems:"center",flexDirection:"row",marginVertical:10}}>
          ...
          <Pressable style={({pressed})=>pressed && {opacity:0.5}} onPress={()=>{
            ...
            <Text style={{color:"#574bf3",textDecorationLine:"underline",fontWeight:"700"}}>Login</Text>
          </Pressable>
          </View>
         <View style={{width:width*0.8}}>
            <Input label="USERNAME :" type="default" placeholder="Enter username" value={username} onChangeText={setUsername}/>
